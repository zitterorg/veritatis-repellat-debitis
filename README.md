# [**@zitterorg/veritatis-repellat-debitis**](https://github.com/zitterorg/veritatis-repellat-debitis)

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
![npm (scoped)](https://img.shields.io/npm/v/@zitterorg/veritatis-repellat-debitis)
![node-current (scoped)](https://img.shields.io/node/v/@zitterorg/veritatis-repellat-debitis)
[![Build Status](https://img.shields.io/github/actions/workflow/status/zitterorg/veritatis-repellat-debitis/git-build.yml?branch=master)](https://img.shields.io/github/actions/workflow/status/zitterorg/veritatis-repellat-debitis/git-build.yml?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/zitterorg/veritatis-repellat-debitis/badge.svg?branch=master)](https://coveralls.io/github/zitterorg/veritatis-repellat-debitis?branch=master)
...
```js
const jt = require('@zitterorg/veritatis-repellat-debitis');
